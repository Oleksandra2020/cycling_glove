...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL6), 0x00000045u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG4), 0x00200000u);
		...
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT1_TR_CTRL0), 0x00055510u);

		/* INT_SELECT Starting address: CYDEV_CPUSS_INT_SEL */
		CY_SET_REG32((void *)(CYREG_CPUSS_INT_SEL), 0x00000010u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT0_BASE), 0x0000003Bu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00D80C40u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC2), 0x00000033u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000061u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x001B1D8Eu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_INTR_CFG), 0x00000008u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00180008u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x0000003Fu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00DA4080u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_INTR_CFG), 0x00000020u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC2), 0x0000000Bu);
