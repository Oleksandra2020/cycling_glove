...
module ADC_SAR_SEQ_P4_v2_50_10 (
    aclk,
    eoc,
    sdone,
    soc,
...
module CapSense_CSD_P4_v2_60_15 ;
...
module top ;
    ...
    CapSense_CSD_P4_v2_60_15 CapSense ();
	...
	cy_psoc3_pins_v1_10
		#(.id("69b51704-fada-4d60-b9f2-105a2a1e506d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("019677e9-43b5-425b-9b7c-3fe925fb867f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a320010f-0557-44b5-b75c-535368ace362"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
