...
#define CYBLE_BIKESTATUS_SERVICE_INDEX   (0x00u) /* Index of BikeStatus service in the cyBle_customs array */
#define CYBLE_BIKESTATUS_BIKESTATUSCHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of BikeStatusCharacteristic characteristic */
#define CYBLE_BIKESTATUS_BIKESTATUSCHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_BIKESTATUS_SERVICE_HANDLE   (0x0010u) /* Handle of BikeStatus service */
#define CYBLE_BIKESTATUS_BIKESTATUSCHARACTERISTIC_DECL_HANDLE   (0x0011u) /* Handle of BikeStatusCharacteristic characteristic declaration */
#define CYBLE_BIKESTATUS_BIKESTATUSCHARACTERISTIC_CHAR_HANDLE   (0x0012u) /* Handle of BikeStatusCharacteristic characteristic */
#define CYBLE_BIKESTATUS_BIKESTATUSCHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
