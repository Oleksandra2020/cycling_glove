...
#define CYBLE_CUSTOMC_BIKESTATUS_SERVICE_INDEX   (0x00u) /* Index of BikeStatus service in the cyBle_customCServ array */
#define CYBLE_CUSTOMC_BIKESTATUS_BIKESTATUSCHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of BikeStatusCharacteristic characteristic */
#define CYBLE_CUSTOMC_BIKESTATUS_BIKESTATUSCHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
