...
#define Up_0_PS		(Up__0__PS)
#define Up_0_PC		(Up__0__PC)
#define Up_0_DR		(Up__0__DR)
#define Up_0_SHIFT	(Up__0__SHIFT)
#define Up_0_INTR	((uint16)((uint16)0x0003u << (Up__0__SHIFT*2u)))
