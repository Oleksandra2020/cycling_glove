// ======================================================================
// Read_gyroscope1.1.v generated from TopDesign.cysch
// 01/17/2021 at 00:54
...
module top ;
	...
	wire [0:0] tmpOE__LedServiceDiscoveryStatus_net;
	wire [0:0] tmpFB_0__LedServiceDiscoveryStatus_net;
	wire [0:0] tmpIO_0__LedServiceDiscoveryStatus_net;
	wire [0:0] tmpINTERRUPT_0__LedServiceDiscoveryStatus_net;
	electrical [0:0] tmpSIOVREF__LedServiceDiscoveryStatus_net;

	cy_psoc3_pins_v1_10
		#(.id("e240861e-0c92-4612-b396-8a5fba19c9be"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		LedServiceDiscoveryStatus
		 (.oe(tmpOE__LedServiceDiscoveryStatus_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedServiceDiscoveryStatus_net[0:0]}),
		  .io({tmpIO_0__LedServiceDiscoveryStatus_net[0:0]}),
		  .siovref(tmpSIOVREF__LedServiceDiscoveryStatus_net),
		  .interrupt({tmpINTERRUPT_0__LedServiceDiscoveryStatus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedServiceDiscoveryStatus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedConnectedStatus_net;
	wire [0:0] tmpFB_0__LedConnectedStatus_net;
	wire [0:0] tmpIO_0__LedConnectedStatus_net;
	wire [0:0] tmpINTERRUPT_0__LedConnectedStatus_net;
	electrical [0:0] tmpSIOVREF__LedConnectedStatus_net;

	cy_psoc3_pins_v1_10
		#(.id("604fa799-3490-4c1e-8d3f-0292aed9bc99"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LedConnectedStatus
		 (.oe(tmpOE__LedConnectedStatus_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedConnectedStatus_net[0:0]}),
		  .io({tmpIO_0__LedConnectedStatus_net[0:0]}),
		  .siovref(tmpSIOVREF__LedConnectedStatus_net),
		  .interrupt({tmpINTERRUPT_0__LedConnectedStatus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedConnectedStatus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedScanningStatus_net;
	wire [0:0] tmpFB_0__LedScanningStatus_net;
	wire [0:0] tmpIO_0__LedScanningStatus_net;
	wire [0:0] tmpINTERRUPT_0__LedScanningStatus_net;
	electrical [0:0] tmpSIOVREF__LedScanningStatus_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LedScanningStatus
		 (.oe(tmpOE__LedScanningStatus_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedScanningStatus_net[0:0]}),
		  .io({tmpIO_0__LedScanningStatus_net[0:0]}),
		  .siovref(tmpSIOVREF__LedScanningStatus_net),
		  .interrupt({tmpINTERRUPT_0__LedScanningStatus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedScanningStatus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
