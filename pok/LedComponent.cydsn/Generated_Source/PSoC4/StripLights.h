...
#define StripLights_GRIDMODE_WRAP    0
    ...
    #define StripLights_ROWS         ((68 +  (10 - 1 ))/(10 ) )
    #define StripLights_TOTAL_LEDS   68

    #define StripLights_ARRAY_COLS   (int32)(68 + 10)
